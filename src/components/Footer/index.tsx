...
const Footer = () => (
  <S.FooterBar>
    <div className="containerFooter">
      ...
      <S.SocialList>
        <S.SocialItem> <img src={instagram_icon} alt="instagram"/></S.SocialItem>
        <S.SocialItem> <img src={facebook_icon} alt="facebook"/></S.SocialItem>
        <S.SocialItem> <img src={twitter_icon} alt="twitter"/></S.SocialItem>
      </S.SocialList>
    </div>
